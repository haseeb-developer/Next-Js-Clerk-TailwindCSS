...
import { MediaFolder } from '../../lib/supabase'
import { useBodyScrollLock } from '../hooks/useBodyScrollLock'

interface DeleteMediaFolderModalProps {
  isOpen: boolean
  folder: MediaFolder
  onClose: () => void
  onConfirm: () => void
...
export function DeleteMediaFolderModal({ isOpen, folder, onClose, onConfirm }: DeleteMediaFolderModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      ...
      >
        ...
        <div className="mt-5">
          ...
          />
          <p className="text-xs text-gray-400 mt-2">This folder will be moved to recycle bin. Media inside will be restored with the folder.</p>
        </div>
